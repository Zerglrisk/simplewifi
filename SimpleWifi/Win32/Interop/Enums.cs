...
namespace SimpleWifi.Win32.Interop
{
    ...
    /// <remarks>
    /// 0 ~ 2 : The only option available on Windows XP SP2.
    /// For Set Profile, dwFlags must be 0. Per-user profiles are not supported.
    /// For Get Profile, Per-user profiles are not supported. Set this parameter to NULL.
    /// </remarks>
    [Flags]
    ...
    /// </remarks>
    /// <see cref="https://msdn.microsoft.com/en-us/library/windows/desktop/ms706015(v=vs.85).aspx"/>
    public enum Dot11PhyType : uint
    {
        ...
        /// <summary>
        /// Specifies a frequency-hopping spread-spectrum (FHSS) PHY type. Bluetooth devices can use FHSS or an adaptation of FHSS.
        /// </summary>
        FHSS = 1,
    ...
    /// </remarks>
    /// <see cref="https://msdn.microsoft.com/en-us/library/windows/desktop/ms705989(v=vs.85).aspx"/>
    ...
    /// </summary>
    /// /// <remarks>
    /// Corresponds to the native <c>DOT11_RADIO_STATE</c> type.
    /// </remarks>
    /// <see cref="https://msdn.microsoft.com/en-us/library/windows/desktop/ms706027(v=vs.85).aspx"/>
    ...
    /// 
    /// </summary>
    /// <see cref="https://www.pinvoke.net/default.aspx/Enums/CryptProtectPromptFlags.html"/>
    [Flags]
    public enum CryptProtectPromptFlags
    {
        ...
        /// </summary>
        CryptprotectPromptOnProtect = 0x1,
        ...
        /// </summary>
        CryptprotectPromptOnUnProtect = 0x2
    }

    /// <summary>
    /// 
    /// </summary>
    /// <see cref="https://www.pinvoke.net/default.aspx/Enums/CryptProtectFlags.html"/>
    [Flags]
    ...
    public enum CryptStringFlags : uint
    {
        ...
        /// </summary>
        CryptStringBASE64HEADER = 0x00000000,

        /// <summary>
        /// Base64, without headers.
        /// </summary>
        CryptStringBASE64 = 0x00000001,

        /// <summary>
        /// Pure binary copy.
        /// </summary>
        CryptStringBINARY = 0x00000002,

        /// <summary>
        /// Base64, with request beginning and ending headers.
        /// </summary>
        CryptStringBASE64REQUESTHEADER = 0x00000003,

        /// <summary>
        /// Hexadecimal only format.
        /// </summary>
        CryptStringHEX = 0x00000004,

        /// <summary>
        /// Hexadecimal format with ASCII character display.
        /// </summary>
        CryptStringHEXASCII = 0x00000005,
        ...
        ///CRYPT_STRING_BASE64
        /// </summary>
        CryptStringBASE64_ANY = 0x00000006,
